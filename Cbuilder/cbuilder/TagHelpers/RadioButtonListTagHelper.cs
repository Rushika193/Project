...
{
    [HtmlTargetElement("radiobuttonlist", TagStructure = TagStructure.NormalOrSelfClosing)]
    public class RadioButtonListListTagHelper : TagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            foreach (SelectListItem item in ListItem)
            {
                ...
                output.Content.AppendHtml("<input class='form-radio' type='radio' id='");
