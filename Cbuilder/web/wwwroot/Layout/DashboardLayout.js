(function () {
    $.PageLayout = function ($pr, p) {
        ...
        var Layout = {
            ...
            ShowRowChooser: function () {
                var self = this;
                CustomModel({
                    heading: "Choose Column",
                    body: $('#divLayoutSample').html(),
                    footer: '',
                    sizeClass: 'modal-dialog-centered modal-lg',
                    advClass: '',
                    onOpen: function ($pr) {
                        $pr.find('.selectData').off('click').on('click', function () {
                            var rowStng = '<ul class="rowStng stng"><li><span class="sortRow fa fa-sort"></span></li><li><span class="removeRow c-pointer fa fa-trash"></span></li></ul>';
                            var colStng = '<ul class="colStng stng"><li><span class="addModule c-pointer fa fa-th-large" title="add module"></span></li></ul>';
                            var $dom = $($(this).html());
                            $dom.prepend(rowStng);
                            self.setLayoutElementAttr($dom);
                          
                            $dom.find('.col').each(function (i, v) {
                                var $ths = $(v);
                                self.setLayoutElementAttr($ths);
                                $ths.html(colStng);
                            });
            ...
            setLayoutElementAttr: function ($ths) {
            ...
            openModuleList: function ($col, $active) {
                ...
                CustomModel({
                    ...
                    footer: '<button type="button" class="btn primary" id="btnUseThisModule">Done</button>',
